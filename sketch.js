...
function preload() {
    ...
    BS = loadSounnd("bath.mp3");
    T = loadSound("brush.mp3");
    DS = loadSound("drink.mp3");
    ES = loadSound("eat.mp3");
    SS = loadSound("sleep.wav");
...
function setup(){
  ...
  behind= createSprite(500,550);
  behind.addImage("b",bg);
  behind.scale=0.3;

//create Astronaut sprite here
  astronaut = createSprite (500,500)
